...
The day has come when you have the ability to put images in the console. Checkout [here for a demo](http://adriancooney.github.io/console.image) and open up the dev tools. Also, check out the awesome [chrome extension](https://github.com/jffry/console.image-chrome-extension) by [@jffry](https://twitter.com/jffry). Console.image now has a little baby sister, **[console.snapshot](http://adriancooney.github.io/console.snapshot)**. It snapshots the canvas and outputs it to the console to make debugging the canvas a little less dramatic. Shoutout to [https://github.com/escusado/console.meme](https://github.com/escusado/console.meme) too, I would have forked it if I realized it existed.
...
```js
console.meme(
  "Not sure if memes in dev tools is stupid",
  "or disastrous.",
  "Not Sure Fry"
);
console.meme(
